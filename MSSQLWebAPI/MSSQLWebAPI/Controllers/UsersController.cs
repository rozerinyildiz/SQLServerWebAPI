...
namespace MSSQLWebAPI.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(MSSQLWebAPIContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<User>> PostUser(User user)
        {
          if (_context.User == null)
          {
              return Problem("Entity set 'MSSQLWebAPIContext.User'  is null.");
          }
        ...
        {
            return (_context.User?.Any(e => e.customerID == id)).GetValueOrDefault();
        }
    }
}
